  ...
  return (
    ...
    >
      <path
        ...
        fill={bodyColor}
      />
      <rect x="16.687" y="19.27" width="5" height="9" rx="2.5" fill={eyeColor} />
      <rect x="26.87" y="19.27" width="5" height="9" rx="2.5" fill={eyeColor} />
    </svg>
  );
}
...
export function BrandMark({
  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className ?? ""}`}>
      <Mascot size={size} bodyColor={bodyColor} />
      {showWordmark && (
        <span
          className="font-gilroy font-extrabold tracking-tight"
          style={{
            color: textColor,
