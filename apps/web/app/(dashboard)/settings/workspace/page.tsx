...
import { ArrowLeft, Settings as Cog } from "lucide-react";

export const metadata = { title: "Spațiul de lucru" };
...
export default function WorkspaceSettingsPage() {
  return (
    <div className="max-w-3xl space-y-7">
      ...
      <div>
        <h1 className="text-h2 font-gilroy text-ink">Spațiul de lucru</h1>
        <p className="mt-1.5 text-[14.5px] text-ink-3">
          Numele, brandul și datele firmei tale.
        </p>
      </div>
