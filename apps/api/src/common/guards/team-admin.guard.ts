 ...
 * Team Admin Guard
 *
 * Verifies that the current user is an admin (owner or admin role)
 * of the team specified in the route parameters.
 *
 ...
 * Usage:
 * ```typescript
 * @UseGuards(SupabaseAuthGuard, TeamAdminGuard)
 * @Patch(':teamId')
 * async updateTeam(@CurrentTeam() team: Team) { ... }
 * ```
 */
@Injectable()
